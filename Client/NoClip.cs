...
namespace Core.Client
{
    public class NoClip : BaseScript
    {
        ...
        public bool NoclipActive { get; set; } = false;
        public NoClip()
        {

        }

        public async void SetNoclipActive(bool active)
        {
            NoclipActive = active;
            await NoClipHandler();
        }

        internal bool IsNoclipActive()
        {
            return NoclipActive;
        }

        public async Task NoClipHandler()
        {
            if (NoclipActive)
            {
