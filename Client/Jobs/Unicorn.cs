...
{
    public class Unicorn : Job
    {
        public Job Metier;
        public ClientMain Client;

        public Vector3 garagePosSortie = new Vector3(136.4f, -1278.7f, 28.6f);
        public Vector3 garagePosEntrer = new Vector3(140.5f, -1263.7f, 29.2f);

        public Vector3 coffreEntreprise = new Vector3(130.5f, -1284.7f, 28.6f);
        public Vector3 clothPos = new Vector3(135.4f, -1288.4f, 28.6f);

        bool is_working = false;

        public Unicorn(ClientMain caller) : base(caller)
        {
            Pool = caller.Pool;
            Client = caller;
        }
